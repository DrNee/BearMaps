...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    ArrayList<GraphDB.Node> refNodes = new ArrayList<>();
    // all the nd ref nodes under a way block
    boolean isValid = false;
    // allowed way or not
    long wayID = 0;
    // id of the way (not sure if I will need it)
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) {
        ...
        if (qName.equals("node")) {
            ...
            // get the id, lon, and lat of each node
...
//            System.out.println("Beginning a way...");
            ...
            // get the nd ref node id
            refNodes.add(g.idToNode.get(id));
            // find the node that matches the nd ref id
            // and store it in the refNodes list
            ...
            if (k.equals("maxspeed")) {
                ...
                if (ALLOWED_HIGHWAY_TYPES.contains(v)) {
                    isValid = true;
                    // set flag to true since allowed way
                }
...
//            System.out.println("Finishing a way...");
            if (isValid) {
                g.addEdge(wayID, refNodes);
                // add the way
                // calling addEdge will take all the ref nd
                // and update the adj list of each
            }
            isValid = false;
